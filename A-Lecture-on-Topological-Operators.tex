...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, breakable, bottomtitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{\textsf{RG flow homomorphism from UV symmetry to IR symmetry}}, colframe=quarto-callout-important-color-frame, toprule=.15mm, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, breakable, bottomtitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{\textsf{Terminology}}, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, breakable, bottomtitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{\textsf{Symmetry/Topological Operator Correspondence}}, colframe=quarto-callout-important-color-frame, toprule=.15mm, opacitybacktitle=0.6, left=2mm]
...
As an operator in the IR theory, it is \emph{not} guaranteed to be
topological (in the sense explained in this lecture). On the other hand,
in the generalized symmetry literature, ``topological defect
...
The correspondence Equation~\ref{eq-conv-STO-corresp} is the core in the
notion of \textbf{generalized (global) symmetry}, coined by
\autocite{Gaiotto:2014kfa} \footnote{The global higher-form symmetry
  ...
  version was essentially knwon from \autocite{KalbRamond}.}.
