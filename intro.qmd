...
To be clear, we are *not* talking about gauge redundancy, which is sometimes called local symmetry. Global, spacetime or internal, symmetries one encounters in a QFT textbook are all locality-preserving.
:::
