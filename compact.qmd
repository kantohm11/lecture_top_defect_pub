...
![](figures/one-form_act.drawio.svg)


![](figures/one_form_passing2.drawio.svg)
...
![](figures/one-form_act.pdf){.content-visible when-format="pdf"}

![](figures/one_form_passing.pdf){.content-visible when-format="pdf"}
