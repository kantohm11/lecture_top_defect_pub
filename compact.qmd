...
![The anomalous phase from the F-move](figures/f_move)

There two ways of such fusion as depicted in the figure, and the two are related by a nontrivial phase which is
$$
f(g_1,g_2,g_3) = ,
$$
