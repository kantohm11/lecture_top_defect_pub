...
When the transformation is trivial, i.e., $g=\id$, the operator $U_{g=\id}[W]$ should also be *trivial*, i.e. should do nothing. This implies that
$$
...
To show the multiplication law for a classical symmetry, 
