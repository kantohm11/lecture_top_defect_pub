...
Let us check the property depicted in @fig-op-action.
To be concrete, we set the insertion $\cdots$ to be $\mathcal{O}_1(x_1)\mathcal{O}_2(x_2)$ with $x_1\in M_L$ and $x_2 \in M_R$.
To see @fig-op-action, we do change of variables $\widetilde{\phi}_R = \phi_R^g$ as
$$
